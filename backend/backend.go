...
type Environment interface {
	...
	// BluetoothConnect tries to connect to the peripheral by the given identifer.
	// Use `backend.bluetooth.State()` to track success/failure.
...
func NewBackend(arguments *arguments.Arguments, environment Environment) (*Backend, error) {
	...
	backend.bluetooth = bluetooth.New()
