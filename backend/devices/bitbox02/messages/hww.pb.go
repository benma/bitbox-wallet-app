...
const (
	...
	BTCSignNextResponse_INPUT_PASS2a BTCSignNextResponse_Type = 2
	BTCSignNextResponse_INPUT_PASS2b BTCSignNextResponse_Type = 3
...
type BTCSignNextResponse struct {
	...
	// Response payload.
	// For INPUT_PASS2a: 33 byte client nonce commitment
	// Fior INPUT_PASS2b: 64 bytes (32 bytes big endian R, 32 bytes big endian S).
...
func (m *BTCSignInputRequest) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
