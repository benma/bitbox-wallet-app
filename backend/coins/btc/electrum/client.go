...
func (c *client) HeadersSubscribe(setupAndTeardown func() func(error), result func(*types.Header, error)) {
...
func (c *client) ScriptHashSubscribe(
	...
	once := sync.Once{}
	c.client.ScriptHashSubscribe(
		context.Background(), string(scriptHashHex),
