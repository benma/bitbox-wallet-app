...
type BlockchainMock struct {
	...
	MockHeadersSubscribe     func(func() func(error), func(*types.Header))
...
func (b *BlockchainMock) HeadersSubscribe(setupAndTeardown func() func(error), success func(*types.Header)) {
